...
#include "AnimExporterITP.h"
#include "Animation/AnimSequence.h"

UAnimExporterITP::UAnimExporterITP(const FObjectInitializer& ObjectInitializer)
	: Super(ObjectInitializer)
{
	SupportedClass = UAnimSequence::StaticClass();
	bText = true;
	PreferredFormatIndex = 0;
	FormatExtension.Add(TEXT("itpanim2"));
	FormatDescription.Add(TEXT("ITP Animation File"));
}

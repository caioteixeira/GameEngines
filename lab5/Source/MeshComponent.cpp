...
void MeshComponent::Extract(std::queue<std::shared_ptr<RenderCommand>>& updateQueue)
{
	auto command = std::make_shared<DrawMeshCommand>(mMesh, mOwner.GetWorldTransform(), mTextureIndex);
